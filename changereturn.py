...
change_left_quarters = (coins_in_quarters * 25) - change
coins_in_dimes = change_left_quarters // 10
change_left_dimes = (coins_in_dimes * 10) - change_left_quarters
coins_in_nickles = change_left_dimes // 5
change_left_nickles = (coins_in_nickles * 5) - change_left_dimes
coins_in_pennies = change_left_nickles // 1
change_left_pennies = (coins_in_pennies * 1) - change_left_nickles
